...
- Render: PROCEDURAL / vector — the game draws itself; NO raster sprites in-engine. (EXCEPTION: a reversible one-sprite SPIKE — the thug — is wired behind `?sprites`, default OFF, procedural figure kept as fallback; a probe to evaluate drawn sprites, not a pipeline commitment.)
...
## CONTROLS (current)
[E]xtort · [C]ollect · [R]einvest · [G]rease · [K]rew · [L] wire · [H]elp · [T] · [Z] frame-city · [F]ollow · [M]arket (off by default) · [U] vice-upgrade · [O] audio panel · [0] mute · [Space] fast-forward (1×/2×/4×) · [>] skip-week · [P] perf overlay. Offensive: [1] Raid · [2] Sabotage · [3] Assassinate · [4] Lockout · [5] Expand · [6] Recruit. Camera: zoom +/- + wheel, WASD/edge/drag pan, 3 zoom stops (CLOSE/MID/FAR). Debug/QA: ?debug=turf|mutiny|win|lose · ?arm=1 · ?art=rich/lean · ?market=on/off · ?reveal=1 · ?life=low|med|high · ?sprites=on/off (one-sprite thug spike; default off, procedural fallback).
